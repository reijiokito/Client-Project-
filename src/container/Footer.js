                ...
                <div className="container-fluid text-center text-md-left">
                    <div className="row">
                        ...
                        <div className="col-md-3 mb-md-0 mb-3">
                            <h5 className="text-uppercase">Producers</h5>

                            <ul className="list-unstyled">
                                <li>
                                    <a target="_blank" href="https://www.facebook.com/romeothecong">Nguyen The Cong</a>
                                </li>
                                <li>
                                    <a target="_blank" href="https://www.facebook.com/profile.php?id=100004256869086">Huynh Dang</a>
                                </li>
                                <li>
                                    <a  target="_blank" href="https://www.facebook.com/pham.tho.94">Pham Tho</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-md-3 mb-md-0 mb-3">                            
